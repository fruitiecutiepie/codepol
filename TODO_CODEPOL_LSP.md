...
interface WorkspaceService {
  ...
  queryDiagnostics(input: DiagnosticsQuery): Promise<WorkspaceDiagnostic[]>;
  ...
  queryWorkspaceSymbols(input: WorkspaceSymbolsQuery): Promise<SymbolResult[]>;

  prepareRename(input: PrepareRenameQuery): Promise<RenameRange | null>;
  runRename(input: RenameCommand): Promise<WorkspaceEditResult>;

  querySemanticSearch(input: SemanticSearchQuery): Promise<SearchResult[]>;
  queryDependencyGraph(input: DependencyGraphQuery): Promise<GraphResult>;
