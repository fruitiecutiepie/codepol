...
- **Tests landed:**
  ...
  - `tests/e2e.cli.graph.spec.ts` (+2 cases) — `codepol graph metrics` JSON shape parity with `WorkspaceArchitectureSummaryResult`; `--fail-on-cycle` exits non-zero on a 2-cycle fixture.
